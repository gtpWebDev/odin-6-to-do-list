...
const projectGeneral = new Project("General", "This is a general catch-all project which will show by default.");
...
function initialiseTaskData() {
  ...
  taskShop.project = projectGeneral;
...
export {
  projects,
  tasks,
  projectGeneral // default project used in tasks
};